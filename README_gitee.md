...
> **首次配置必看**
> 1. 手机连接 WiFi **`ESurfing-Config`**，密码：**`esurfing2024`**
> 2. 浏览器打开 **http://192.168.4.1** 填写校园网账号和 WiFi 信息
> 3. 点击保存，ESP32 自动重启并开始认证
...
从 [Releases](https://gitee.com/MYHealer/esp32_esurfing/releases) 下载对应芯片的 `XXX_v1.0.0.zip` 包。
