...
> 
> 固件可在 [GitHub Releases](https://github.com/MYHealer/esp32_esurfing/releases) 下载，选择对应芯片的 zip 包。
...
从 [GitHub Releases](https://github.com/MYHealer/esp32_esurfing/releases) 下载对应芯片的固件 zip 包，按下方「快速开始」中的方法烧录。
...
从 [GitHub Releases](https://github.com/MYHealer/esp32_esurfing/releases) 下载对应芯片的 `XXX_v1.0.0.zip` 包。
